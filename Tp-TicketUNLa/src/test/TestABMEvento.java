...
public class TestABMEvento {
	...
	public static void main(String[] args) {
		try {
			...
			Auditorio auditorio=e.buscarAuditorio(1);
			Auditorio auditorio2=e.buscarAuditorio(2);
			Auditorio auditorio3=e.buscarAuditorio(3);
			...
			Evento evento = e.buscarEvento(1);
			evento.agregarFuncion(f1,auditorio, 0.05);
			evento.agregarTarifa(230,auditorio.buscarSector("pullman"));
			Evento evento2 = e.buscarEvento(2);
			evento2.agregarFuncion(f2, auditorio2, 0.09);
			evento2.agregarTarifa(450, auditorio2.buscarSector("popular"));
			Evento evento3 = e.buscarEvento(3);
			evento3.agregarFuncion(f1, auditorio3, 0.25);
			evento3.agregarTarifa(400, auditorio3.buscarSector("pullman"));
