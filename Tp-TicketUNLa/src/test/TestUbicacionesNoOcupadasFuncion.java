...
public class TestUbicacionesNoOcupadasFuncion {
	...
	public static void main(String[] args) {
		...
		try{
			...
			System.out.println("Ubicaciones disponibles para el evento: "+sis.traerEvento(1).getNombre()+ ", funcion: "+Funciones.traerFechaCortaHora(sis.traerEvento(1).traerFuncion(1).getFecha()));
			System.out.println(sis.traerEvento(1).traerFuncion(1).ubicacionesLibres());
		}
		catch(Exception e){
